...
if (!class_exists('SH_Deeds_Resizer')) {



    class SH_Deeds_Resizer {



        public function deeds_resize($url, $width = null, $height = null, $crop = true, $align = 'c', $image_url = false, $retina = false) {

            global $wpdb;

            $common = $this->deeds_info($url, $width, $height, $crop, $align, $retina);
            ...
            if($image_url)
                ...
                return '<img width="' . $width . '" height="' . $height . '" src="' . $resized_url . '" alt="'.esc_attr__( 'image', 'deeds' ).'"/>';

        }



        public function deeds_info($url, $width, $height, $crop, $align, $retina) {
        ...
        public function deeds_delResizer($post_id) {
            ...
            $pathinfo = pathdeeds_info($metadata['file']);
