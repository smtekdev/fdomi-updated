	...
	function vp_enqueue() {
		...
		if ( isset( $uri ) ) {
			...
			if ( $file == 'edit-tags.php' ) {
				...
				wp_register_script( 'select2', WP_PLUGIN_DIR . '/deeds/vafpress/public/js/vendor/select2.min.js', array(), '4.0', true );

				wp_register_script( 'cate', WP_PLUGIN_DIR . '/deeds/vafpress/public/js/vendor/category.js', array(), '4.0', true );

				wp_enqueue_style( 'select2', WP_PLUGIN_DIR . '/deeds/vafpress/public/css/vendor/select2.css', array(), '4.0', 'all' );
