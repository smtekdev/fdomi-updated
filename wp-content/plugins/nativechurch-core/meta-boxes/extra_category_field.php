       ...
       <table class="form-table">
           <tbody><tr class="form-field form-required">
                   ...
                   <td><?php
                       ...
                       echo '<input id="upload_category_button" type="button" class="button button-primary" value="'.esc_html__('Upload Image', 'framework').'" /> ';
                      if(isset($_REQUEST['tag_ID'])){
                       echo '<input id="upload_category_button_remove" type="button" class="button button-primary" value="'.esc_html__('Remove Image', 'framework').'" />';
                      }
                       ?>
