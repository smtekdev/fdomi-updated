<?php
function nativechurch_shortcode_prepare()
{
// Require config
//require_once('config.php');
wp_enqueue_style('imic_font_awesome_thickbox');
$icon_list = '';
...
wp_enqueue_script('imic1');
wp_enqueue_script('imic2');
wp_enqueue_script('imic3');
wp_enqueue_style('imic4');
wp_enqueue_style('imic5');
wp_enqueue_style('imic6');
?>

<!-- IMIC Framework Shortcode Panel -->
<!-- OPEN html -->
        <!-- OPEN imicframework_shortcode_form -->
        <form class="nativechurch-shortcode-creator" name="imicframework_shortcode_form" action="#">
            <!-- OPEN #shortcode_wrap -->
            <div id="shortcode_wrap">
                <!-- CLOSE #shortcode_panel -->
                <div id="shortcode_panel" class="current">
                    <fieldset>
                        <h4><?php _e('Select a shortcode', 'framework'); ?></h4>
                        <div class="nativechurch-shortcodes-option">
                            <label for="shortcode-select"><?php _e('Shortcode', 'framework'); ?></label>
                            <select id="shortcode-select" name="shortcode-select">
                                <option value="0"></option>
                                <option value="shortcode-accordion" data-shortcode="accordions"><?php _e('Accordions', 'framework'); ?></option>
                                <option value="shortcode-buttons" data-shortcode="imic_button"><?php _e('Button', 'framework'); ?></option>
                                <option value="shortcode-columns" data-shortcode="imic_columns"><?php _e('Columns', 'framework'); ?></option>
                                <option value="shortcode-counters" data-shortcode="imic_count"><?php _e('Counters', 'framework'); ?></option>
                                <option value="shortcode-form" data-shortcode="imic_form"><?php _e('Form', 'framework'); ?></option>
                                <option value="shortcode-calendar" data-shortcode="event_calendar"><?php _e('Calendar', 'framework'); ?></option>
                                <option value="shortcode-icons" data-shortcode="icon"><?php _e('Icons', 'framework'); ?></option>
                                <option value="shortcode-imagebanner" data-shortcode="imic_image"><?php _e('Image', 'framework'); ?></option>
                                <option value="shortcode-lists" data-shortcode="list"><?php _e('Lists', 'framework'); ?></option>
                                <option value="shortcode-modal" data-shortcode="modal_box"><?php _e('Modal Box', 'framework'); ?></option>
                                <option value="shortcode-progressbar" data-shortcode="progress_bar"><?php _e('Progress Bar', 'framework'); ?></option>
                                <option value="shortcode-staff" data-shortcode="staff"><?php _e('Staff', 'framework'); ?></option>
                                <option value="shortcode-sermon" data-shortcode="sermon"><?php _e('Sermon', 'framework'); ?></option>
                                <option value="shortcode-sidebar" data-shortcode="sidebar"><?php _e('Sidebar', 'framework'); ?></option>
                                <option value="shortcode-event" data-shortcode="event"><?php _e('Latest events', 'framework'); ?></option>
                                <option value="shortcode-tables" data-shortcode="htable"><?php _e('Table', 'framework'); ?></option>
                                <option value="shortcode-tooltip" data-shortcode="imic_tooltip"><?php _e('Tooltip', 'framework'); ?></option>
                                <option value="shortcode-typography" data-shortcode="typography"><?php _e('Typography', 'framework'); ?></option>
                                <option value="shortcode-tabs" data-shortcode="tabs"><?php _e('Tabs', 'framework'); ?></option>
                                <option value="shortcode-toggle" data-shortcode="toggles"><?php _e('Toggles', 'framework'); ?></option>
                                <option value="shortcode-fwvideo" data-shortcode="fullscreenvideo"><?php _e('Fullwidth Video', 'framework'); ?></option>
                            </select>
                        </div>
                        <!--//////////////////////////////
                        ////	BUTTONS
                        //////////////////////////////-->
                        <div id="shortcode-buttons" class="nativechurch-shortcode-sections" style="display:none;">
                            <h5><?php _e('Buttons', 'framework'); ?></h5>
                            <div class="nativechurch-shortcodes-option">
                                <label for="button-colour"><?php _e('Button colour', 'framework'); ?></label>
                                <select id="button-colour" name="button-colour">
                                    <option value="btn-default"><?php _e('Default', 'framework'); ?></option>
                                    <option value="btn-primary"><?php _e('Primary', 'framework'); ?></option>
                                    <option value="btn-success"><?php _e('Success', 'framework'); ?></option>
                                    <option value="btn-info"><?php _e('Info', 'framework'); ?></option>
                                    <option value="btn-warning"><?php _e('Warning', 'framework'); ?></option>
                                    <option value="btn-danger"><?php _e('Danger', 'framework'); ?></option>
                                </select>
                            </div>
                            <div class="nativechurch-shortcodes-option">
                                <label for="button-type"><?php _e('Button type', 'framework'); ?></label>
                                <select id="button-type" name="button-type">
                                    <option value="enabled"><?php _e('Enabled', 'framework'); ?></option>
                                    <option value="disabled"><?php _e('Disabled', 'framework'); ?></option>
                                </select>
                            </div>
                            <div class="nativechurch-shortcodes-option">
                                <label for="button-text"><?php _e('Button text', 'framework'); ?></label>
                                <input id="button-text" name="button-text" type="text" value="<?php _e('Button text', 'framework'); ?>"/>
                            </div>
                            <div class="nativechurch-shortcodes-option">
                                <label for="button-url"><?php _e('Button URL', 'framework'); ?></label>
                                <input id="button-url" name="button-url" type="text" value="http://"/>
                            </div>
                            <div class="nativechurch-shortcodes-option">
                                <label for="button-target" class="for-checkbox"><?php _e('Open link in a new window?', 'framework'); ?></label>
                                <input id="button-target" class="checkbox" name="button-target" type="checkbox"/>
                            </div>
                            <div class="nativechurch-shortcodes-option">
                                <label for="button-size"><?php _e('Button Size', 'framework'); ?></label>
                                <select id="button-size" name="button-size">
                                    <option value=""><?php _e('Default', 'framework'); ?></option>
                                    <option value="btn-xs"><?php _e('Extra Small', 'framework'); ?></option>
                                    <option value="btn-sm"><?php _e('Small', 'framework'); ?></option>
                                    <option value="btn-lg"><?php _e('Large', 'framework'); ?></option>
                                </select>
                            </div>
                            <div class="nativechurch-shortcodes-option">
                                <label for="button-extraclass"><?php _e('Button Extra Class', 'framework'); ?></label>
                                <input id="button-extraclass" name="button-extraclass" type="text" value=""/>
                                <p class="info"><?php _e('Optional, for extra styling/custom colour control.', 'framework'); ?></a></p>
                            </div>
                        </div>
                        <!--//////////////////////////////
                       ////	FULLSCREEN VIDEO
                       //////////////////////////////-->
                        <div id="shortcode-fwvideo" class="nativechurch-shortcode-sections" style="display:none;">
                            <h5><?php _e('Fullwidth Video', 'framework'); ?></h5>
                            <div class="nativechurch-shortcodes-option">
                                <label for="fwvideo-videourl"><?php _e('Video URL', 'framework'); ?></label>
                                <input id="fwvideo-videourl" name="fwvideo-videourl" type="text" value=""/>
                                <p class="info"><?php _e('Enter the video URL here. Vimeo/YouTube are supported, and please make sure you enter the full video URL, not shortened, and HTTP only.', 'framework'); ?></p>
                                <label for="fw-video" class="for-checkbox"><?php _e('Enable Full width', 'framework'); ?></label>
                               	<input id="fw-video" class="checkbox" name="fw-video" type="checkbox"/>
                                
                                <label for="fwvideo-autoplay"><?php _e('Autoplay', 'framework'); ?></label>
                                <select id="fwvideo-autoplay" name="fwvideo-autoplay">
                                    <option value="0"><?php _e('No', 'framework'); ?></option>
                                    <option value="1"><?php _e('Yes', 'framework'); ?></option>
                                </select>
                            </div>
                        </div>
                        <!--//////////////////////////////
                        ////	ICONS
                        //////////////////////////////-->
                        <div id="shortcode-icons" class="nativechurch-shortcode-sections" style="display:none;">
                            <h5><?php _e('Icons', 'framework'); ?></h5>
                            <div class="nativechurch-shortcodes-option">
                                <label for="icon-image"><?php _e('Icon image', 'framework'); ?></label>
                                <input id="icon-image" class="nativechurch-icon-field" name="icon-image" type="text" value="" style="visibility: hidden;"/>
                        ...
                        ////	TYPOGRAPHY
                        //////////////////////////////-->
                        <div id="shortcode-typography" class="nativechurch-shortcode-sections" style="display:none;">
                            <h5><?php _e('Typography', 'framework'); ?></h5>
                            <div class="nativechurch-shortcodes-option">
                                <label for="typography-type"><?php _e('Type', 'framework'); ?></label>
                                <select id="typography-type" name="typography-type">
                                    <option value="0"></option>
                                    <option value="typo-anchor"><?php _e('Anchor Tag', 'framework'); ?></option>
                                    <option value="typo-heading"><?php _e('Heading', 'framework'); ?></option>
                                    <option value="typo-paragraph"><?php _e('Paragraph', 'framework'); ?></option>
                                    <option value="typo-span"><?php _e('Span Tag', 'framework'); ?></option>
                                    <option value="typo-divider"><?php _e('Divider', 'framework'); ?></option>
                                    <option value="typo-container"><?php _e('Container', 'framework'); ?></option>
                                    <option value="typo-alert"><?php _e('Alert Box', 'framework'); ?></option>
                                    <option value="typo-blockquote"><?php _e('Blockquote', 'framework'); ?></option>
                                    <option value="typo-dropcap"><?php _e('Dropcap', 'framework'); ?></option>
                                    <option value="typo-code"><?php _e('Code', 'framework'); ?></option>
                                    <option value="typo-label"><?php _e('Label', 'framework'); ?></option>
                                    <option value="typo-spacer"><?php _e('Spacer', 'framework'); ?></option>
                                    <option value="typo-section"><?php _e('Section', 'framework'); ?></option>
                                </select>
                            </div>
                            <!-- ANCHOR TAG -->
                            <div id="typo-anchor" class="nativechurch-sub-shortcode" style="display:none;">
                                <h5><?php _e('Anchor Tag', 'framework'); ?></h5>
                                <div class="nativechurch-shortcodes-option">
                                    <label for="anchor-href"><?php _e('Anchor Link', 'framework'); ?></label>
                                    <input id="anchor-href" name="anchor-href" type="text" value=""/>
                                </div>
                                <div class="nativechurch-shortcodes-option">
                                    <label for="anchor-xclass"><?php _e('Add Extra Class', 'framework'); ?></label>
                                    <input id="anchor-xclass" name="anchor-xclass" type="text" value=""/>
                                </div>
                            </div>
                            <!-- PARAGRAPH -->
                            <div id="typo-paragraph" class="nativechurch-sub-shortcode" style="display:none;">
                                <h5><?php _e('Paragraph', 'framework'); ?></h5>
                                <div class="nativechurch-shortcodes-option">
                                    <label for="paragraph-xclass"><?php _e('Add Extra Class', 'framework'); ?></label>
                                    <input id="paragraph-xclass" name="paragraph-xclass" type="text" value=""/>
                                </div>
                            </div>
                            <!-- SPAN -->
                            <div id="typo-span" class="nativechurch-sub-shortcode" style="display:none;">
                                <h5><?php _e('Span Tag', 'framework'); ?></h5>
                                <div class="nativechurch-shortcodes-option">
                                    <label for="span-xclass"><?php _e('Add Extra Class', 'framework'); ?></label>
                                    <input id="span-xclass" name="span-xclass" type="text" value=""/>
                                </div>
                            </div>
                            <!-- DIVIDER -->
                            <div id="typo-divider" class="nativechurch-sub-shortcode" style="display:none;">
                                <h5><?php _e('Divider', 'framework'); ?></h5>
                                <div class="nativechurch-shortcodes-option">
                                    <label for="divider-extra"><?php _e('Add Extra Class', 'framework'); ?></label>
                                    <input id="divider-extra" name="divider-extra" type="text" value=""/>
                                </div>
                            </div>
                            <!-- HEADINGS -->
                            <div id="typo-heading" class="nativechurch-sub-shortcode" style="display:none;">
                                <h5><?php _e('Heading', 'framework'); ?></h5>
                                <div class="nativechurch-shortcodes-option">
                                    <label for="heading-size"><?php _e('Select Heading Tag', 'framework'); ?></label>
                                    <select id="heading-size" name="heading-size">
                                        <option value="h1"><?php _e('H1', 'framework'); ?></option>
                                        <option value="h2"><?php _e('H2', 'framework'); ?></option>
                                        <option value="h3"><?php _e('H3', 'framework'); ?></option>
                                        <option value="h4"><?php _e('H4', 'framework'); ?></option>
                                        <option value="h5"><?php _e('H5', 'framework'); ?></option>
                                        <option value="h6"><?php _e('H6', 'framework'); ?></option>
                                    </select>
                                </div>
                                <div class="nativechurch-shortcodes-option">
                                    <label for="heading-extra"><?php _e('Add Extra Class', 'framework'); ?></label>
                                    <input id="heading-extra" name="heading-extra" type="text" value=""/>
                                </div>
                            </div>
                            <!-- ALERT BOX -->
                            <div id="typo-alert" class="nativechurch-sub-shortcode" style="display:none;">
                                <h5><?php _e('Alert Box', 'framework'); ?></h5>
                                <div class="nativechurch-shortcodes-option">
                                    <label for="alert-type"><?php _e('Select Alert Box type', 'framework'); ?></label>
                                    <select id="alert-type" name="alert-type">
                                        <option value="alert-standard"><?php _e('Standard', 'framework'); ?></option>
                                        <option value="alert-warning"><?php _e('Warning', 'framework'); ?></option>
                                        <option value="alert-error"><?php _e('Error', 'framework'); ?></option>
                                        <option value="alert-info"><?php _e('Info', 'framework'); ?></option>
                                        <option value="alert-success"><?php _e('Success', 'framework'); ?></option>
                                    </select>
                                </div>
                                <div class="nativechurch-shortcodes-option">
                                    <label for="alert-close" class="for-checkbox"><?php _e('Add Close Button', 'framework'); ?></label>
                                    <input id="alert-close" class="checkbox" name="alert-close" type="checkbox"/>
                                </div>
                            </div>
                            <!-- BLOCKQUOTE -->
                            <div id="typo-blockquote" class="nativechurch-sub-shortcode" style="display:none;">
                                <h5><?php _e('Blockquote', 'framework'); ?></h5>
                                <div class="nativechurch-shortcodes-option">
                                    <label for="blockquote-name"><?php _e('Blockquote Author Name', 'framework'); ?></label>
                                    <input id="blockquote-name" name="blockquote-name" type="text" value=""/>
                                </div>
                            </div>
                            <!-- DROPCAP -->
                            <div id="typo-dropcap" class="nativechurch-sub-shortcode" style="display:none;">
                                <h5><?php _e('Dropcap', 'framework'); ?></h5>
                                <div class="nativechurch-shortcodes-option">
                                    <label for="dropcap-type"><?php _e('Dropcap Type', 'framework'); ?></label>
                                    <select id="dropcap-type" name="dropcap-type">
                                        <option value=""><?php _e('Style 1', 'framework'); ?></option>
                                        <option value="secondary"><?php _e('Style 2', 'framework'); ?></option>
                                    </select>
                                </div>
                            </div>
                            <!-- CODE -->
                            <div id="typo-code" class="nativechurch-sub-shortcode" style="display:none;">
                                <h5><?php _e('Code', 'framework'); ?></h5>
                                <div class="nativechurch-shortcodes-option">
                                    <label for="code-type"><?php _e('Code Type', 'framework'); ?></label>
                                    <select id="code-type" name="code-type">
                                        <option value=""><?php _e('Standard', 'framework'); ?></option>
                                        <option value="inline"><?php _e('Inline', 'framework'); ?></option>
                                    </select>
                                </div>
                            </div>                            
                            <!-- Container -->
                            <div id="typo-container" class="nativechurch-sub-shortcode" style="display:none;">
                                <h5><?php _e('Container', 'framework'); ?></h5>
                                <div class="nativechurch-shortcodes-option">
                                    <label for="container-xclass"><?php _e('Add Extra Class', 'framework'); ?></label>
                                    <input id="container-xclass" name="container-xclass" type="text" value=""/>
                                </div>
                            </div>                            
                            <!-- SECTION -->
                            <div id="typo-section" class="nativechurch-sub-shortcode" style="display:none;">
                                <h5><?php _e('Section', 'framework'); ?></h5>
                                <div class="nativechurch-shortcodes-option">
                                    <label for="section-xclass"><?php _e('Add Extra Class', 'framework'); ?></label>
                                    <input id="section-xclass" name="section-xclass" type="text" value=""/>
                                </div>
                            </div>
                            <!-- SPACER -->
                            <div id="typo-spacer" class="nativechurch-sub-shortcode" style="display:none;">
                                <h5><?php _e('Spacer', 'framework'); ?></h5>
                                <div class="nativechurch-shortcodes-option">
                                    <label for="spacer-size"><?php _e('Select Spacer', 'framework'); ?></label>
                                    <select id="spacer-size" name="spacer-size">
                                        <option value="spacer-20"><?php _e('Spacer-20', 'framework'); ?></option>
                                        <option value="spacer-30"><?php _e('Spacer-30', 'framework'); ?></option>
                                        <option value="spacer-40"><?php _e('Spacer-40', 'framework'); ?></option>
                                        <option value="spacer-50"><?php _e('Spacer-50', 'framework'); ?></option>
                                        <option value="spacer-75"><?php _e('Spacer-75', 'framework'); ?></option>
                                        <option value="spacer-100"><?php _e('Spacer-100', 'framework'); ?></option>
                                    </select>
                                </div>
                            </div>
                            
                            <!-- LABEL TAGS -->
                            <div id="typo-label" class="nativechurch-sub-shortcode" style="display:none;">
                                <h5><?php _e('Label', 'framework'); ?></h5>
                                <div class="nativechurch-shortcodes-option">
                                    <label for="label-type"><?php _e('Select Label Tag', 'framework'); ?></label>
                                    <select id="label-type" name="label-type">
                                        <option value="label-default"><?php _e('Default', 'framework'); ?></option>
                                        <option value="label-primary"><?php _e('Primary', 'framework'); ?></option>
                                        <option value="label-success"><?php _e('Success', 'framework'); ?></option>
                                        <option value="label-info"><?php _e('Info', 'framework'); ?></option>
                                        <option value="label-warning"><?php _e('Warning', 'framework'); ?></option>
                                        <option value="label-danger"><?php _e('Danger', 'framework'); ?></option>
                                        <option value="label-dark"><?php _e('Dark', 'framework'); ?></option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        ////	COLUMNS
                        //////////////////////////////-->
                        <div id="shortcode-columns" class="nativechurch-shortcode-sections" style="display:none;">
                            <h5><?php _e('Columns', 'framework'); ?></h5>
                            <div class="nativechurch-shortcodes-option">
                                <label for="column-options"><?php _e('Layout', 'framework'); ?></label>
                            ...
                            <div class="nativechurch-shortcodes-option">
                                <label for="column-xclass"><?php _e('Add Extra Class', 'framework'); ?></label>
                                <input id="column-xclass" name="column-xclass" type="text" value=""/>
                            </div>
                            <div class="nativechurch-shortcodes-option">
                                <label for="column-animation"><?php _e('Animation', 'framework'); ?></label>
                                <select id="column-animation" name="column-animation">
                                    <option value=""></option>
                                    <option value="bounceInRight"><?php _e('From Right', 'framework'); ?></option>
                                    <option value="bounceInLeft"><?php _e('From Left', 'framework'); ?></option>
                                </select>
                            </div>
                        </div>
                        <!--//////////////////////////////
                        ////	PROGRESS BAR
                        //////////////////////////////-->
                        <div id="shortcode-progressbar" class="nativechurch-shortcode-sections" style="display:none;">
                            <h5><?php _e('Progress Bar', 'framework'); ?></h5>
                            <div class="nativechurch-shortcodes-option">
                                <label for="progressbar-percentage"><?php _e('Percentage', 'framework'); ?></label>
                                <input id="progressbar-percentage" name="progressbar-percentage" type="text" value=""/>
                                <p class="info"><?php _e('Enter the percentage of the progress bar.', 'framework'); ?></p>
                            </div>
                            <div class="nativechurch-shortcodes-option">
                                <label for="progressbar-text"><?php _e('Progress Text', 'framework'); ?></label>
                                <input id="progressbar-text" name="progressbar-text" type="text" value=""/>
                                <p class="info"><?php _e('Enter the text that you\'d like shown above the bar, i.e. "COMPLETED".', 'framework'); ?></p>
                            </div>
                            <div class="nativechurch-shortcodes-option">
                                <label for="progressbar-value"><?php _e('Progress Value', 'framework'); ?></label>
                                <input id="progressbar-value" name="progressbar-value" type="text" value=""/>
                                <p class="info"><?php _e('Enter value that you\'d like shown at the end of the bar on completion, i.e. "90".', 'framework'); ?></p>
                            </div>
                            <div class="nativechurch-shortcodes-option">
                                <label for="progressbar-type"><?php _e('Progress Bar Type', 'framework'); ?></label>
                                <select id="progressbar-type" name="progressbar-type">
                                    <option value=""><?php _e('Standard', 'framework'); ?></option>
                                    <option value="progress-striped"><?php _e('Striped', 'framework'); ?></option>
                                    <option value="colored"><?php _e('Colored', 'framework'); ?></option>
                                </select>
                            </div>
                            <div class="nativechurch-shortcodes-option">
                                <label for="progressbar-colour"><?php _e('Progress Bar Colour Type', 'framework'); ?></label>
                                <select id="progressbar-colour" name="progressbar-colour">
                                    <option value="progress-bar-primary"><?php _e('Primary', 'framework'); ?></option>
                                    <option value="progress-bar-success"><?php _e('Success', 'framework'); ?></option>
                                    <option value="progress-bar-info"><?php _e('Info', 'framework'); ?></option>
                                    <option value="progress-bar-warning"><?php _e('Warning', 'framework'); ?></option>
                                    <option value="progress-bar-danger"><?php _e('Danger', 'framework'); ?></option>
                                </select>
                                <p class="info"><?php _e('Select progress bar color for progress bar type striped and colored.', 'framework'); ?></p>
                            </div>
                        </div>
                        <!--//////////////////////////////
                                                ////	MODAL BOX
                                                //////////////////////////////-->
                        <div id="shortcode-modal" class="nativechurch-shortcode-sections" style="display:none;">
                            <h5><?php _e('Modal Box', 'framework'); ?></h5>
                            <div class="nativechurch-shortcodes-option">
                                <label for="modal-id"><?php _e('Modal Box ID', 'framework'); ?></label>
                                <input id="modal-id" name="modal-id" type="text" value=''/>
                            </div>
                            <div class="nativechurch-shortcodes-option">
                                <label for="modal-title"><?php _e('Modal Box Title', 'framework'); ?></label>
                                <input id="modal-title" name="modal-title" type="text" value=''/>
                            </div>
                            <div class="nativechurch-shortcodes-option">
                                <label for="modal-text"><?php _e('Modal Box Body Text', 'framework'); ?></label>
                                <input id="modal-text" name="modal-text" type="text" value=''/>
                            </div>
                            <div class="nativechurch-shortcodes-option">
                                <label for="modal-button"><?php _e('Modal Box Button Text', 'framework'); ?></label>
                        ...
                        ////	TOOLTIP
                        //////////////////////////////-->
                        <div id="shortcode-tooltip" class="nativechurch-shortcode-sections" style="display:none;">
                            <h5><?php _e('Tooltip', 'framework'); ?></h5>
                            <div class="nativechurch-shortcodes-option">
                                <label for="tooltip-text"><?php _e('Text', 'framework'); ?></label>
                                <input id="tooltip-text" name="tooltip-text" type="text" value=''/>
                                <p class="info"><?php _e('Enter the text for the tooltip.', 'framework'); ?></p>
                            </div>
                            <div class="nativechurch-shortcodes-option">
                                <label for="tooltip-link"><?php _e('Link', 'framework'); ?></label>
                                <input id="tooltip-link" name="tooltip-link" type="text" value=""/>
                                <p class="info"><?php _e('Enter the link that the tooltip text links to.', 'framework'); ?></p>
                            </div>
                            <div class="nativechurch-shortcodes-option">
                                <label for="tooltip-direction"><?php _e('Direction', 'framework'); ?></label>
                                <select id="tooltip-direction" name="tooltip-direction">
                                    <option value="top"><?php _e('Top', 'framework'); ?></option>
                                    <option value="bottom"><?php _e('Bottom', 'framework'); ?></option>
                                    <option value="left"><?php _e('Left', 'framework'); ?></option>
                                    <option value="right"><?php _e('Right', 'framework'); ?></option>
                                </select>
                                <p class="info"><?php _e('Choose the direction in which the tooltip appears.', 'framework'); ?></p>
                            </div>
                        </div>
                        <!--//////////////////////////////
                        ////	COUNTERS
                        //////////////////////////////-->
                        <div id="shortcode-counters" class="nativechurch-shortcode-sections" style="display:none;">
                            <h5><?php _e('Counters', 'framework'); ?></h5>
                            <div class="nativechurch-shortcodes-option">
                                <label for="count-to"><?php _e('To Value', 'framework'); ?></label>
                                <input id="count-to" name="count-to" type="text" value=""/>
                                <p class="info"><?php _e('Enter the number from which the counter counts up to.', 'framework'); ?></p>
                            </div>
                            <div class="nativechurch-shortcodes-option">
                                <label for="count-subject"><?php _e('Subject Text', 'framework'); ?></label>
                                <input id="count-subject" name="count-subject" type="text" value=""/>
                                <p class="info"><?php _e('Enter the text which you would like to show below the counter.', 'framework'); ?></p>
                            </div>
                            <div class="nativechurch-shortcodes-option">
                                <label for="count-speed"><?php _e('Speed', 'framework'); ?></label>
                                <input id="count-speed" name="count-speed" type="text" value=""/>
                                <p class="info"><?php _e('Enter the time you want the counter to take to complete, this is in milliseconds and optional. The default is 2000.', 'framework'); ?></p>
                            </div>
                            <div class="nativechurch-shortcodes-option">
                                <label for="count-image"><?php _e('Icon image', 'framework'); ?></label>
                                <input id="count-image" class="nativechurch-icon-field" name="count-image" type="text" value="" style="visibility: hidden;"/>
                                <ul class="font-icon-grid"><?php echo ''.$icon_list; ?></ul>
                            </div>
                            <div class="nativechurch-shortcodes-option">
                                <label for="count-textstyle"><?php _e('Text style', 'framework'); ?></label>
                                <select id="count-textstyle" name="count-textstyle">
                                    <option value="div"><?php _e('Default', 'framework'); ?></option>
                                    <option value="h3"><?php _e('H3', 'framework'); ?></option>
                                    <option value="h6"><?php _e('H6', 'framework'); ?></option>
                                </select>
                            </div>
                        ...
                        ////	IMAGE BANNER
                        //////////////////////////////-->
                        <div id="shortcode-imagebanner" class="nativechurch-shortcode-sections" style="display:none;">
                            <h5><?php _e('Image', 'framework'); ?></h5>
                            <div class="nativechurch-shortcodes-option">
                                <label for="imagebanner-image"><?php _e('Image URL', 'framework'); ?></label>
                                <input id="imagebanner-image" name="imagebanner-image" type="text" value=""/>
                                <p class="info"><?php _e('Provide the URL here for the background image that you would like to use.', 'framework'); ?></p>
                            </div>
                            <div class="nativechurch-shortcodes-option">
                                <label for="imagebanner-width"><?php _e('Image Width', 'framework'); ?></label>
                                <input id="imagebanner-width" name="imagebanner-width" type="text" value=""/>
                                <p class="info"><?php _e('Provide image width in pixels.', 'framework'); ?></p>
                            </div>
                            <div class="nativechurch-shortcodes-option">
                                <label for="imagebanner-height"><?php _e('Image Height', 'framework'); ?></label>
                                <input id="imagebanner-height" name="imagebanner-height" type="text" value=""/>
                                <p class="info"><?php _e('Provide image height in pixels.', 'framework'); ?></p>
                            </div>
                            <div class="nativechurch-shortcodes-option">
                                <label for="imagebanner-extraclass"><?php _e('Add Extra class', 'framework'); ?></label>
                        ...
                        <?php $terms = get_terms( 'staff-category');
								 $staff_terms=array();
								  ?>
                        <div id="shortcode-staff" class="nativechurch-shortcode-sections" style="display:none;">
                            <h5><?php _e('Staff', 'framework'); ?></h5>
                            <div class="nativechurch-shortcodes-option">
                                <label for="staff-number"><?php _e('Number of Staff', 'framework'); ?></label>
                                <input id="staff-number" name="staff-number" type="text" value="" />
                            </div>
                            <div class="nativechurch-shortcodes-option">
                                <label for="staff-order"><?php _e('Order By Menu', 'framework'); ?></label>
                                <select id="staff-order" name="pagination-size">
                                    <option value="no"><?php _e('No', 'framework'); ?></option>
                                    <option value="yes"><?php _e('Yes', 'framework'); ?></option>
                                </select>
                            </div>
                            <div class="nativechurch-shortcodes-option">
                                <label for="staff-category"><?php _e('Staff Categories', 'framework'); ?></label>
                            ...
                            <div class="nativechurch-shortcodes-option">
                                <label for="staff-column"><?php _e('Column Structure', 'framework'); ?></label>
                                <select id="staff-column" name="staff-column">
                                		<option value="0"><?php _e('Select', 'framework'); ?></option>
                                    <option value="4"><?php _e('Four', 'framework'); ?></option>
                                    <option value="3"><?php _e('Three', 'framework'); ?></option>
                                    <option value="2"><?php _e('Two', 'framework'); ?></option>
                                    <option value="1"><?php _e('One', 'framework'); ?></option>
                                </select>
                            </div>
                            <div class="nativechurch-shortcodes-option">
                                <label for="staff-excerpt-length"><?php _e('Length of Excerpt to show', 'framework'); ?></label>
                                <input id="staff-excerpt-length" name="staff-excerpt-length" type="text" value="" />
                            </div>
                        </div>
                        <!-- SIDEBAR -->
                            <div id="shortcode-sidebar" class="nativechurch-shortcode-sections" style="display:none;">
                                <h5><?php _e('Sidebar', 'framework'); ?></h5>
                                <div class="nativechurch-shortcodes-option">
                                    <label for="sidebar-listing"><?php _e('Select Sidebar', 'framework'); ?></label>
                                ...
                                <div class="nativechurch-shortcodes-option">
                                <label for="sidebar-column"><?php _e('Select column for sidebar', 'framework'); ?></label>
                                <select id="sidebar-column" name="sidebar-column">
                                		<option value="0"><?php _e('Select', 'framework'); ?></option>
                                    <option value="6"><?php _e('Half', 'framework'); ?></option>
                                    <option value="8"><?php _e('one-third', 'framework'); ?></option>
                                    <option value="12"><?php _e('Full', 'framework'); ?></option>
                                </select>
                            </div>
                             </div>
                        <!--//////////////////////////////
                        ...
                        $sermon_terms = array();
                        ?>
                        <div id="shortcode-sermon" class="nativechurch-shortcode-sections" style="display:none;">
                            <h5><?php _e('Sermon', 'framework'); ?></h5>
                            <div class="nativechurch-shortcodes-option">
                                <label for="sermon-title"><?php _e('Enter Title', 'framework'); ?></label>
                                <input id="sermon-title" name="sermon-title" type="text" value="" />
                            </div>
                            <div class="nativechurch-shortcodes-option">
                                <label for="sermon-number"><?php _e('Number of Sermon', 'framework'); ?></label>
                                <input id="sermon-number" name="sermon-number" type="text" value="" />
                            </div>
                            <div class="nativechurch-shortcodes-option">
                                <label for="sermon-category"><?php _e('Sermon Categories', 'framework'); ?></label>
                             ...
                             <div class="nativechurch-shortcodes-option">
                             <label for="sermon-column"><?php _e('Column Structure', 'framework'); ?></label>
                                    ...
                                    $event_terms = array();
                                    ?>
                                    <div id="shortcode-event" class="nativechurch-shortcode-sections" style="display:none;">
                                        <h5><?php _e('Latest events', 'framework'); ?></h5>
                                        <div class="nativechurch-shortcodes-option">
                                            <label for="event-title"><?php _e('Enter Title', 'framework'); ?></label>
                                            <input id="event-title" name="event-title" type="text" value="" />
                                        </div>
                                        <div class="nativechurch-shortcodes-option">
                                            <label for="event-number"><?php _e('Number of Event', 'framework'); ?></label>
                                            <input id="event-number" name="event-number" type="text" value="" />
                                        </div>
                                        <div class="nativechurch-shortcodes-option">
                                            <label for="event-style"><?php _e('Style', 'framework'); ?></label>
                                            <select id="event-style" name="event-style">
                                                <option value="grid"><?php _e('Grid', 'framework'); ?></option>
                                                <option value="list"><?php _e('List', 'framework'); ?></option>
                                            </select>
                                        </div>
                                        <div class="nativechurch-shortcodes-option">
                                            <label for="event-category"><?php _e('Event Categories', 'framework'); ?></label>
                                          ...
                                          <div class="nativechurch-shortcodes-option">
                                            <label for="event-type"><?php _e('Event Type', 'framework'); ?></label>
                                            <select id="event-type" name="event-type">
                                                <option value="future"><?php _e('Future', 'framework'); ?></option>
                                                <option value="past"><?php _e('Past', 'framework'); ?></option>
                                            </select>
                                        </div>    
                                    </div>
                        <!--//////////////////////////////
                        ////	TABLE
                        //////////////////////////////-->
                        <div id="shortcode-tables" class="nativechurch-shortcode-sections" style="display:none;">
                            <h5><?php _e('Table', 'framework'); ?></h5>
                            <div class="nativechurch-shortcodes-option">
                                <label for="table-type"><?php _e('Table style', 'framework'); ?></label>
                                <select id="table-type" name="table-type">
                                    <option value="table-striped"><?php _e('Striped table', 'framework'); ?></option>
                                    <option value="table-bordered"><?php _e('Bordered table', 'framework'); ?></option>
                                </select>
                            </div>
                            <div class="nativechurch-shortcodes-option">
                                <label for="table-head"><?php _e('Table Head', 'framework'); ?></label>
                                <select id="table-head" name="table-head">
                                    <option value="yes"><?php _e('Yes', 'framework'); ?></option>
                                    <option value="no"><?php _e('No', 'framework'); ?></option>
                                    <p class="info"><?php _e('Include a heading row in the table', 'framework'); ?></p>
                                </select>
                            </div>
                            <div class="nativechurch-shortcodes-option">
                                <label for="table-columns"><?php _e('Number of columns', 'framework'); ?></label>
                            ...
                            <div class="nativechurch-shortcodes-option">
                                <label for="table-rows"><?php _e('Number of rows', 'framework'); ?></label>
                        ...
                        ////	LISTS
                        //////////////////////////////-->
                        <div id="shortcode-lists" class="nativechurch-shortcode-sections" style="display:none;">
                            <h5><?php _e('Lists', 'framework'); ?></h5>
                            <div class="nativechurch-shortcodes-option">
                                <label for="list-type"><?php _e('List style', 'framework'); ?></label>
                                <select id="list-type" name="list-type">
                                    <option value=""><?php _e('Custom Unordered List', 'framework'); ?></option>
                                    <option value="unordered"><?php _e('Unordered List', 'framework'); ?></option>
                                    <option value="ordered"><?php _e('Ordered List', 'framework'); ?></option>
                                    <option value="icon"><?php _e('Icon List', 'framework'); ?></option>
                                    <option value="inline"><?php _e('Inline List', 'framework'); ?></option>
                                    <option value="desc"><?php _e('Description List', 'framework'); ?></option>
                                </select>
                            </div>
                            <div class="nativechurch-shortcodes-option">
                                <label for="list-icon"><?php _e('List icon', 'framework'); ?></label>
                                <input id="list-icon" name="list-icon" type="text" value="" style="visibility: hidden;"/>
                                <ul class="font-icon-grid"><?php echo ''.$icon_list; ?></ul>
                            </div>
                            <div class="nativechurch-shortcodes-option">
                                <label for="list-items"><?php _e('Number of list items', 'framework'); ?></label>
                                <select id="list-items" name="list-items">
                                    ...
                                    <option value="9">9</option>
                                    <option value="10">10</option>
                                    <p class="info"><?php _e('You can easily add more by duplicating the code after.','framework'); ?></p>
                                </select>
                            </div>
                            <div class="nativechurch-shortcodes-option">
                                <label for="list-extra"><?php _e('Add Extra Class', 'framework'); ?></label>
                        ...
                        <!--//////////////////////////////
                                                ////	Tabs
                                                //////////////////////////////-->
                        <div id="shortcode-tabs" class="nativechurch-shortcode-sections" style="display:none;">
                            <h5><?php _e('Tabs', 'framework'); ?></h5>                            
                            <div class="nativechurch-shortcodes-option">
                                <label for="tabs-id"><?php _e('Tab ID', 'framework'); ?></label>
                                <input id="tabs-id" name="tabs-id" type="text" value=""/>
                            </div>
                            <div class="nativechurch-shortcodes-option">
                                <label for="tabs-size"><?php _e('Number of Tabs', 'framework'); ?></label>								<input id="tabs-size" name="tabs-size" type="text" value=""/>
                            </div>
                        </div>
                        <!--//////////////////////////////
                                                ////	Accordions
                                                //////////////////////////////-->
                        <div id="shortcode-accordion" class="nativechurch-shortcode-sections" style="display:none;">
                            <h5><?php _e('Accordions', 'framework'); ?></h5>
                            <div class="nativechurch-shortcodes-option">
                                <label for="accordion-id"><?php _e('Accordion ID', 'framework'); ?></label>
                                <input id="accordion-id" name="accordion-id" type="text" value=""/>
                            </div>
                            <div class="nativechurch-shortcodes-option">
                                <label for="accordion-size"><?php _e('Number of Accordions', 'framework'); ?></label>
                        ...
                        <!--//////////////////////////////
                                                ////	Toggles
                                                //////////////////////////////-->
                        <div id="shortcode-toggle" class="nativechurch-shortcode-sections" style="display:none;">
                            <h5><?php esc_html_e('Toggles', 'framework'); ?></h5>
                            <div class="nativechurch-shortcodes-option">
                                <label for="toggle-id"><?php esc_html_e('Toggle ID', 'framework'); ?></label>
                                <input id="toggle-id" name="toggle-id" type="text" value=""/>
                            </div>
                            <div class="nativechurch-shortcodes-option">
                                <label for="toggle-size"><?php esc_html_e('Number of Toggles', 'framework'); ?></label>
                        ...
                        <!--//////////////////////////////
                                                ////	Form
                                                //////////////////////////////-->
                        <div id="shortcode-form" class="nativechurch-shortcode-sections" style="display:none;">
                        ...
                        <!--//////////////////////////////
                                                //// Calendar	
                                                //////////////////////////////-->
                        <div id="shortcode-calendar" class="nativechurch-shortcode-sections" style="display:none;">
                ...
                <div class="buttons clearfix">
                    <input type="submit" id="nativechurch_insert-shortcode" name="insert" class="button" value="<?php esc_html_e('Insert Shortcode', 'framework'); ?>"/>
                </div>
...
add_action('wp_ajax_nativechurch_shortcode_prepare', 'nativechurch_shortcode_prepare');