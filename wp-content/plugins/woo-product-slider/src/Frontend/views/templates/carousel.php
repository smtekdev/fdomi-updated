...
<div id="wps-slider-section" class="wps-slider-section wps-slider-section-<?php echo esc_attr( $post_id ); ?>">
	...
	?>
	<div id="sp-woo-product-slider-<?php echo esc_attr( $post_id ); ?>" class="wps-product-section sp-wps-<?php echo esc_attr( $template_class ); ?>" <?php echo wp_kses_post( $slider_data . ' ' . $the_rtl ); ?>>
